...
import { Check, FileText, Pencil, Plus, Tag, Trash2 } from "lucide-react";
      ...
      <Dialog open={isOpen} onOpenChange={(v) => !v && onClose()}>
        <DialogContent className="sm:max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
          <DialogHeader>
            ...
            <DialogDescription>
              Gerencie os tipos utilizados para classificar as despesas
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex-1 overflow-y-auto px-6 pb-5">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 border border-dashed border-slate-200 rounded-xl">
                ...
                <p className="text-sm text-slate-400">Nenhum tipo de despesa cadastrado</p>
                <button
                  onClick={openCreate}
      ...
      <Dialog open={formOpen} onOpenChange={(v) => !v && setFormOpen(false)}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {editing
                ? "Atualize os dados do tipo de despesa"
                : "Preencha os dados para criar um novo tipo de despesa"}
            </DialogDescription>
          </DialogHeader>
