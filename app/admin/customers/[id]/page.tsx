...
export default function CustomerDetailPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="bg-white/80 backdrop-blur-sm border-white/30 shadow-lg">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-gray-900">Histórico de Compras</CardTitle>
          <CardDescription>
                ...
                <tbody>
                  {orders.map((order) => (
                    <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <Badge className={`${getStatusInfo(order.status).color} border px-2 py-1 rounded-full text-xs font-medium`}>
