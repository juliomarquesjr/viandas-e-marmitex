          ...
          <div className="flex items-center gap-1.5">
            {hasAnyFilter ? (
              <>
                ...
                <span className="text-xs text-slate-400 dark:text-slate-500">de {totalCount} clientes</span>
              </>
            ) : (
              <>
                <span className="text-sm font-bold text-slate-800 tabular-nums dark:text-slate-100">
                ...
                <span className="text-xs text-slate-400 dark:text-slate-500">clientes</span>
              </>
            )}
          </div>
        )}
        ...
        <div className="space-y-1.5 shrink-0 w-full sm:w-[160px]">
          ...
          <div className="relative">
            ...
            >
              ...
              <SelectContent
                className="z-[9999] border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
                position="popper"
                side="bottom"
                align="start"
              >
